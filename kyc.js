...
const Kyc = () => {
   ...
   return (
    ...
    <Text style={{color:'#fff',fontSize:16,fontWeight:800}}>Aadhar Verification</Text>
     ...
     <View style={{paddingHorizontal:20,flexDirection:'column',gap:10}}>
      ...
      <View style={{ flexDirection: 'column', justifyContent: 'space-between',paddingVertical:10,gap:30,width:'100%' }}>
        <View style={{flexDirection:'column',gap:5}}>
      <Text style={{ fontSize: 15, fontWeight: 700 }}>Upload Aadhar Card Image (Front)</Text>
     <View style={{flexDirection:'column',alignItems:'flex-end',justifyContent:'center',borderWidth:1,borderRadius:5,padding:5}}>
        ...
        >
          <Image
            source={image ? { uri: image } : require('./assets/upload.png')} // Display selected image or default icon
        ...
        <View style={{flexDirection:'column',gap:5}}>
        <Text style={{ fontSize: 15, fontWeight: 700 }}>Upload Aadhar Card Image (Back)</Text>
        <View style={{flexDirection:'column',alignItems:'flex-end',justifyContent:'center',borderWidth:1,borderRadius:5,padding:5}}>
