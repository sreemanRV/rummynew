    ...
    <Text style={{color:'#fff',fontSize:16,fontWeight:800}}>Add Cash</Text>
     ...
     <View style={{padding:20,flexDirection:'column',gap:10,backgroundColor:'#fff'}}>
      ...
      <View style={{paddingHorizontal:20}}>
        ...
        <Image source={require('./assets/sbi.jpg')} style={styles.bank} />
        <Text>Sbi</Text>
        </View>
        <View style={{flexDirection:'column',gap:6,alignItems:"center"}}>
        <Image source={require('./assets/citi.png')} style={styles.bank} />
        <Text>Citi</Text>
        </View>
        <View style={{flexDirection:'column',gap:6,alignItems:"center"}}>
        <Image source={require('./assets/axis.jpg')} style={styles.bank} />
        <Text>Axis</Text>
        </View>
        <View style={{flexDirection:'column',gap:6,alignItems:"center"}}>
        <Image source={require('./assets/canara.jpg')} style={styles.bank} />
        <Text>Canara</Text>
        </View>
        </View>
        </View>
